    ...
    <div className="min-h-screen relative" style={{
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="relative z-10 text-center max-w-4xl px-6">
          <div className="mb-8">
            <div className="w-24 h-1 bg-gradient-to-r from-transparent via-green-700 to-transparent mx-auto mb-8"></div>
            <h1 className="text-6xl md:text-8xl font-bold tracking-wider mb-6 text-slate-800"
                style={{ fontFamily: "'Great Vibes', cursive", fontWeight: 400 }}>
              Приглашение
            </h1>
            <div className="w-32 h-1 bg-gradient-to-r from-transparent via-green-700 to-transparent mx-auto mb-12"></div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <Card className="bg-white/95 backdrop-blur-md border-slate-200 hover:border-slate-300 transition-all duration-300 shadow-xl hover:shadow-2xl">
              <CardContent className="p-8 text-center">
                <div className="mb-6">
                  <Icon name="Calendar" size={48} className="text-green-700 mx-auto mb-4" />
            ...
            {/* Location */}
            <Card className="bg-white/95 backdrop-blur-md border-green-200 hover:border-green-300 transition-all duration-300 shadow-xl hover:shadow-2xl">
              <CardContent className="p-8 text-center">
                <div className="mb-6">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="text-center bg-white/90 backdrop-blur-md rounded-lg p-8 shadow-xl border border-slate-200">
              <div className="mb-8">
                <Icon name="Shirt" size={48} className="text-green-700 mx-auto mb-4" />
            ...
            <div className="text-center bg-white/90 backdrop-blur-md rounded-lg p-8 shadow-xl border border-slate-200">
              <div className="mb-8">
                <Icon name="Gift" size={48} className="text-green-700 mx-auto mb-4" />
                <h3 className="text-3xl text-slate-700 mb-6 font-bold"
                    style={{ fontFamily: "'Great Vibes', cursive" }}>
                  О подарках
                </h3>
      ...
      <section className="py-20 px-6 relative">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-transparent via-green-700 to-transparent mx-auto"></div>
          </div>
            ...
            <CardContent className="p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="text-center pt-6">
                  <Button
                    type="submit"
                    className="bg-gradient-to-r from-green-700 to-green-600 text-white font-bold px-6 py-3 rounded-full hover:from-green-800 hover:to-green-700 transition-all duration-300 transform hover:scale-105 shadow-lg text-sm leading-tight max-w-xs mx-auto"
                    style={{ fontFamily: "'Comfortaa', sans-serif" }}
                  >
      ...
      <footer className="py-8 px-6 border-t border-slate-300/50 relative">
        <div className="max-w-4xl mx-auto text-center bg-white/80 backdrop-blur-sm rounded-lg p-6">
          <div className="w-16 h-1 bg-gradient-to-r from-transparent via-green-700 to-transparent mx-auto mb-4"></div>
